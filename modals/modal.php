...
<div class="modal fade" style="font-family: 'Roboto', sans-serif; font-size: 0.9em; text-align: center" id="add-modal-for" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div style="border-radius: 8px" class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span style="font-size: 0.6em" aria-hidden="true">Cerrar</span>
                </button>
            </div>
            <div class="modal-body">
                        ...
                        <form class="form-horizontal">
                            <div class="row">
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="provider['prv_id_proveedor']" placeholder="000<?php echo last() + 1?>" disabled>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="">Nombre</label>
                                    <input type="text" class="form-control" name="provider['prv_nombre']">
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="provider['prv_cuit']">
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group mb-2 mr-sm-2">
                                        ...
                                        <input type="text" class="form-control" name="provider['prv_email']">
                                    </div>
                                </div>
                            </div>
                            <div class="line"></div>
