...
<html>
    ...
    function loginfailed() {
        ...
        }, 5000); // Redirige después de 5 segundos (ajustable)
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="info d-flex align-items-center">
                                <div class="content">
                                    <div class="logo">
                                        <a><img src="img\logo.png" alt="" width="75%"/></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="content">
                                    <form method="post" class="form-validate">
                                        <div class="form-group">
                                            <input id="login-username" type="text" name="loginUsername" placeholder="Usuario" required data-msg="Por favor ingrese con su usuario" class="input-material">
                                        </div>
                                        <div class="form-group">
                                            <input id="login-password" type="password" name="loginPassword" placeholder="Contraseña" required data-msg="Por favor ingrese su contraseña" class="input-material">
                                        </div><input class="btn btn-primary" type="submit" value="Ingresar"><br/><br/>
